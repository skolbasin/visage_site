...
const faqItems = [
  {
    ...
    answer: 'Использую преимущественно люксовую и профессиональную косметику (в том числе Dior, Gucci, Tom Ford, а также профессиональные и доступные бренды). Если у вас есть аллергия или чувствительная кожа — сообщите заранее, подберём подходящие средства.',
  },
  {
    id: 2,
    question: 'Делаете ли вы пробный макияж?',
    answer: 'Да, пробный образ делаю по желанию клиента. Чаще всего он нужен перед свадьбой, чтобы спокойно согласовать образ до торжества, а также для знакомства с мастером.',
  },
  {
    id: 3,
