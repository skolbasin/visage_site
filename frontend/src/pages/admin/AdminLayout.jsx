    ...
    <>
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
        ...
        <div className="mb-2">
          ...
          <div className="ml-6 space-y-1">
            ...
            >
              ...
              {counts.bookings > 0 && (
                <span className="bg-red-500 text-white text-xs rounded-full px-2 py-0.5">{counts.bookings}</span>
              )}
            </Link>
            <Link
            ...
            >
              ...
              {counts.certificates > 0 && (
                <span className="bg-red-500 text-white text-xs rounded-full px-2 py-0.5">{counts.certificates}</span>
              )}
            </Link>
            <Link
              to="/admin/questions"
            ...
            >
              ...
              {counts.questions > 0 && (
                <span className="bg-red-500 text-white text-xs rounded-full px-2 py-0.5">{counts.questions}</span>
              )}
            </Link>
          </div>
        </div>
        ...
        <Link
          to="/admin/portfolio"
          className={`flex items-center gap-3 px-3 py-2 rounded-lg transition ${
            location.pathname === '/admin/portfolio' ? 'bg-[#4a7c59] text-white' : 'text-gray-700 hover:bg-gray-100'
          }`}
        >
          <FolderOpen size={20} />
          <span>Портфолио</span>
